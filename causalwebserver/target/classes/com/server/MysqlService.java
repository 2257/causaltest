                         ...
                         HttpServletResponse response) throws ServletException, IOException
    {
        ...
        switch (type)
        {
            ...
            case "read": {
                ...
                field.add(col);
                msg = mysql.read(tableName, key, field,1);
            ...
            case "read2": {
                ...
                Set<String> field = new HashSet<>();
                field.add(col);
                msg = mysql.read(tableName, key, field,2);
                //  System.out.println("msg==="+msg);
                break;
            }
            case "insert": {
                ...
                mysql.insert(tableName, id, col, val,"nul",1);
                break;
            }
            case "insert2": {
                String id = request.getParameter("id");
                String col = request.getParameter("col");
                String val = request.getParameter("val");
                mysql.insert(tableName, id, col, val,"nul",2);
                break;
            }
            case "delete": {
                // System.out.println("servlet cass delete");
                String id = request.getParameter("id");
                mysql.delete(tableName,  id,"nul");
