...
public class CassandraAmazonWFR extends AmazonWFR
{
    ...
    {
        return "?type=insert2&tableName=amazoncommoditytable&keyrow=id&key="+commodity+"&col=descri&val="+descri+"&time="+
