...
public class HbaseAmazonWFR extends AmazonWFR
{
    int typid = 18;
    ...
    public String read()
    {
        return "?type=read&key="+question+"&fields=content&tableName=amazonquestiontable2";
    }
    public String read2()
    {
    ...
    {
        return "?type=insert2&tableName=amazonquestiontable2&keyrow="+question+"&col=content&val="+content+"&time="+
