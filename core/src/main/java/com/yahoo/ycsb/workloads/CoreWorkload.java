...
public class CoreWorkload extends Workload {
  ...
  {
    String url = "?type=init";
    RestWorkload.request.add(url);
  }
  public void cleanstmt()
  {
    String url = "?type=cleanup";
    RestWorkload.request.add(url);
  }
  public void createtablestmt()
  {
    String url = "?type=createtable&tableName=k123.twitterusertable&fields=id,text,tweetid,text,liketweet,text,retweet,text,commenttweet,text,time,text&pk=id";
    RestWorkload.request.add(url);
